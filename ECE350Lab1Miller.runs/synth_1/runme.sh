...
HD_PWD='C:/Users/ryan1/OneDrive/Documents/Projects/ECE350Lab1Miller/ECE350Lab1Miller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log compute_c_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source compute_c_top.tcl
