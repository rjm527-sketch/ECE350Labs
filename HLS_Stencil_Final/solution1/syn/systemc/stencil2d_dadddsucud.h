...
// ==============================================================
#ifndef __stencil2d_dadddsucud__HH__
#define __stencil2d_dadddsucud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(stencil2d_dadddsucud) {
    ...
    SC_CTOR(stencil2d_dadddsucud):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
