...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "stencil2d.autotvin.dat"
	set constFileTvOut       "stencil2d.autotvout.dat"
	set constFileHdlTvIn     "stencil2d.autohdltvin.dat"
	set constFileHdlTvOut    "stencil2d.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
