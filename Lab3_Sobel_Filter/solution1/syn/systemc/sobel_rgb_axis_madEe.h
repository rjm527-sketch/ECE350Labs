...
// ==============================================================
#ifndef __sobel_rgb_axis_madEe__HH__
#define __sobel_rgb_axis_madEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_rgb_axis_madEe) {
    ...
    SC_CTOR(sobel_rgb_axis_madEe):  simcore_mac_0_U ("simcore_mac_0_U") {
