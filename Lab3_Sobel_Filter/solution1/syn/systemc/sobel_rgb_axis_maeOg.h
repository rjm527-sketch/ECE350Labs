...
// ==============================================================
#ifndef __sobel_rgb_axis_maeOg__HH__
#define __sobel_rgb_axis_maeOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_rgb_axis_maeOg) {
    ...
    SC_CTOR(sobel_rgb_axis_maeOg):  simcore_mac_1_U ("simcore_mac_1_U") {
